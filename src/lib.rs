...
///
/// ```
/// let future: dep::BoxFuture<u64> = dep::boxed(async { 123 });
/// drop(future);
/// ```
...
impl DependencyError {
    ...
    ///
    /// ```
    /// let error = dep::DependencyError::missing("clock.now");
    ...
    ///
    /// ```
    /// let error = dep::DependencyError::message("boom");
...
///
/// ```
/// let future = dep::boxed(async { String::from("hello") });
/// let future: dep::BoxFuture<String> = future;
/// drop(future);
/// ```
...
/// }
///
/// assert_eq!(dep::get::<demo::Clock>().now_millis(), 1234);
/// ```
pub fn get<D>() -> D
where
    D: Dependency,
...
/// dep::unimplemented_dependency("demo.missing");
/// ```
...
impl OverrideBuilder {
    ...
    ///
    /// ```
    /// let _builder = dep::OverrideBuilder::new();
    /// ```
    pub fn new() -> Self {
        Self::default()
    }
